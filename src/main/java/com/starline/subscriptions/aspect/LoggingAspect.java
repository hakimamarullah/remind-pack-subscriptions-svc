package com.starline.subscriptions.aspect;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.starline.subscriptions.config.LoggingContext;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(@com.starline.subscriptions.annotations.LogRequestResponse * *(..))")
    public void methodWithLoggedRequestResponse() {
    }


    @Pointcut("within(@com.starline.subscriptions.annotations.LogRequestResponse *)")
    public void classWithLogRequestResponse() {
    }

    @Pointcut("within(@com.starline.subscriptions.annotations.LogResponse *)")
